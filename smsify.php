...
function smsify_menu() {
	$page = add_menu_page( 'SMSify - bulk SMS delivery', 'SMSify', 'manage_options', 'wp-smsify-settings', null, '/wp-content/plugins/smsify/images/favicon.ico' );
	$page_setup = add_submenu_page( 'wp-smsify-settings', 'Settings', 'Settings', 'manage_options', 'wp-smsify-settings', 'smsify_plugin_settings');
	$page_app = add_submenu_page( 'wp-smsify-settings', 'SMSify', 'Send SMS', 'manage_options', 'wp-smsify-app', 'smsify_plugin_app');
    $page_import = add_submenu_page( 'wp-smsify-settings', 'SMSify', 'Bulk Import', 'manage_options', 'wp-smsify-import', 'smsify_bulk_import');
